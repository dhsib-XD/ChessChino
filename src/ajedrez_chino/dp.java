...
public class dp {
    ...
    public void nuevo() {
        ...
        aceptar.addActionListener(e -> {
            ...
            if (pass.length() == 5) {
                if (revU(0, user)) {
                    jugadores[totalUsuarios] = new Jugador(user, pass);
                    totalUsuarios++;
        ...
        nu.setVisible(true); // ✅ ahora al final
    }

    public boolean revU(int a, String usu) {
        if (a >= totalUsuarios) {
            return true;
        }
        if (jugadores[a].getNombre().equals(usu)) {
            return false;
        }
        return revU(a + 1, usu);
    }
    ...
    public boolean verificar(int a, String usu, String contra) {
        ...
        if (jugadores[a].getNombre().equals(usu) && jugadores[a].getContrasena().equals(contra)) {
            Jactual = a;
            return true;
        }
    ...
    public void MICUENTA() {
        ...
        JLabel nombreLabel = new JLabel("Usuario: " + jugadores[Jactual].getNombre());
        nombreLabel.setBounds(150, 120, 250, 35);
    ...
    public void cambio() {
        ...
        aceptar.addActionListener(e -> {
            ...
            if (!jugadores[Jactual].getContrasena().equals(actual_c)) {
    ...
    public void cerrar() {
        ...
        eliminar.addActionListener(e -> {
            ...
            if (jugadores[Jactual].getContrasena().equals(c)) {

                for (int i = Jactual; i < totalUsuarios - 1; i++) {
                    jugadores[i] = jugadores[i + 1];
                }

                jugadores[totalUsuarios - 1] = null;
                totalUsuarios--;
                Jactual = -1;
                ...
                JOptionPane.showMessageDialog(ce, "Contrasena incorrecta");
            }
        });
